...
import '../bloc/password_reset_sent_cubit.dart';
...
class PasswordResetSentScreen extends StatelessWidget {
  ...
  Future<void> _resendResetLink(BuildContext context, PasswordResetSentCubit cubit) async {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => PasswordResetSentCubit(),
      child: Builder(
        builder: (context) {
          final cubit = context.read<PasswordResetSentCubit>();
          return Scaffold(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      BlocBuilder<PasswordResetSentCubit, PasswordResetSentState>(
                          ...
                          return SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: state.remainingSeconds > 0 || state.isResending
                                  ? null
                                  : () => _resendResetLink(context, cubit),
