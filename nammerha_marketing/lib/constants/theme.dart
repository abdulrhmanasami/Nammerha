...
class SemanticColors {
  ...
  static const textPrimary = Color('#1E293B');
  static const textSecondary = Color('#64748B');
  
  static const strokeBorder = Color('#E2E8F0');
  static const success = Color('#10B981');
  static const error = Color('#EF4444');
  static const glassCard = Color('#D9FFFFFF'); // Represented in CSS typically as rgba
}
