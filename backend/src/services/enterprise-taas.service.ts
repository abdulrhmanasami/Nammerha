...
// Transparency-as-a-Service for institutional donors (NGOs, INGOs, funds).
...
export async function getImpactReport(): Promise<ImpactReport> {
    ...
    return {
        ...
        completion_rate: totalProjects > 0
            ? Math.round((completed / totalProjects) * 10000) / 100
            : 0,
        verification_rate: materialsDelivered > 0
            ? Math.round((totalProofs / materialsDelivered) * 10000) / 100
            : 0,
