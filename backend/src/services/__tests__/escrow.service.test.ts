        ...
        it('should atomically release escrow, update BOQ, and notify donors', async () => {
            const mockClient = {
                query: vi.fn()
                    ...
                    .mockResolvedValueOnce({
                        rows: [
                            { transaction_id: 'tx-001', donor_id: 'donor-001', amount_locked: 300000 },
                            { transaction_id: 'tx-002', donor_id: 'donor-002', amount_locked: 200000 },
                        ],
                        rowCount: 2,
                    })
                ...
                query: vi.fn()
                    .mockResolvedValueOnce({
                        rows: [{
                            ...
                            project_id: 'proj-001', engineer_id: 'eng-001',
                            verification_status: 'submitted', image_url: 'url',
                        }],
                        rowCount: 1,
                    })
                    .mockResolvedValueOnce({ rows: [], rowCount: 1 })
                    ...
                    .mockResolvedValueOnce({
                        rows: [
                            { transaction_id: 'tx-001', donor_id: 'donor-001', amount_locked: 100000 },
                            { transaction_id: 'tx-002', donor_id: 'donor-001', amount_locked: 200000 },
                            { transaction_id: 'tx-003', donor_id: 'donor-001', amount_locked: 300000 },
                        ],
                        rowCount: 3,
                    })
                    .mockResolvedValueOnce({ rows: [], rowCount: 1 })
