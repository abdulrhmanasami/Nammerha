...
const ROLE_FIELD_WHITELIST: Readonly<Record<string, readonly string[]>> = {
    contractor: [
        'company_name', 'trade_category', 'years_experience', 'service_areas',
        'portfolio_urls', 'max_concurrent_projects', 'commercial_license_number',
        'insurance_expiry', 'insurance_status', 'commercial_license_url',
        'insurance_document_url', 'verification_status',
    ],
    engineer: [
        'specialization', 'university', 'graduation_year', 'years_experience',
        'professional_memberships', 'certification_urls', 'engineering_license_number',
        'license_expiry', 'license_status', 'engineering_license_url',
        'verification_status',
    ],
    supplier: [
        'company_name', 'supply_categories', 'delivery_radius_km', 'min_order_amount',
        'warehouse_address', 'commercial_register_number', 'register_status',
        'commercial_register_expiry', 'commercial_register_url', 'verification_status',
    ],
    tradesperson: [
        'trade_type', 'years_experience', 'daily_rate', 'tools_owned',
        'availability_status', 'guild_membership_id', 'guild_expiry',
        'guild_document_url', 'certification_expiry', 'verification_status',
    ],
    homeowner: [
        'property_type', 'displacement_status', 'family_size',
        'property_address', 'ownership_proof_url', 'verification_status',
    ],
    donor: [
        'preferred_causes', 'preferred_currency', 'is_anonymous_default',
        'donation_count', 'total_donated_amount', 'tax_receipt_email',
    ],
} as const;
...
const DEFAULT_SETTINGS: Readonly<Record<string, PrivacyFieldSettings>> = {
    contractor: {
        company_name: 'public', trade_category: 'public', years_experience: 'public',
        service_areas: 'public', portfolio_urls: 'public',
        max_concurrent_projects: 'project_members', commercial_license_number: 'project_members',
        insurance_expiry: 'project_members', insurance_status: 'project_members',
        commercial_license_url: 'private', insurance_document_url: 'private',
        verification_status: 'private',
    },
    engineer: {
        specialization: 'public', university: 'public', graduation_year: 'public',
        years_experience: 'public', professional_memberships: 'public',
        certification_urls: 'project_members', engineering_license_number: 'project_members',
        license_expiry: 'project_members', license_status: 'project_members',
        engineering_license_url: 'private', verification_status: 'private',
    },
    supplier: {
        company_name: 'public', supply_categories: 'public', delivery_radius_km: 'public',
        min_order_amount: 'public',
        warehouse_address: 'project_members', commercial_register_number: 'project_members',
        register_status: 'project_members', commercial_register_expiry: 'project_members',
        commercial_register_url: 'private', verification_status: 'private',
    },
    tradesperson: {
        trade_type: 'public', years_experience: 'public', daily_rate: 'public',
        tools_owned: 'public', availability_status: 'public',
        guild_membership_id: 'project_members', guild_expiry: 'project_members',
        certification_expiry: 'project_members',
        guild_document_url: 'private', verification_status: 'private',
    },
    homeowner: {
        property_type: 'public',
        displacement_status: 'project_members',
        family_size: 'private', property_address: 'private',
        ownership_proof_url: 'private', verification_status: 'private',
    },
    donor: {
        preferred_causes: 'public', preferred_currency: 'public',
        is_anonymous_default: 'private', donation_count: 'private',
        total_donated_amount: 'private', tax_receipt_email: 'private',
    },
};
    ...
    for (const [role, fields] of Object.entries(newSettings)) {
        ...
        for (const [field, visibility] of Object.entries(fields)) {
            ...
            if (!VALID_VISIBILITIES.has(visibility)) {
                logger.warn('Privacy update: invalid visibility ignored', { userId, role, field, visibility });
                continue;
            }
