...
describe('Marketplace & Crowdfunding (Unit)', () => {
    ...
    describe('BOQ Funding Validation', () => {
        it('should cap donation amount at remaining need (prevent over-funding)', () => {
            const totalCost = 100_000; // cents
            const funded = 85_000;
            const remainingNeed = totalCost - funded;
            const donationAmount = 20_000;
            const actualAmount = Math.min(donationAmount, remainingNeed);
            expect(actualAmount).toBe(15_000); // Capped at remaining
        });

        it('should reject donation to fully funded item', () => {
        ...
        it('should reject zero or negative donation amount', () => {
...
describe('Translation Service (Unit)', () => {
    describe('Content Type Detection', () => {
        ...
        it('should default to creative for prose', () => {
            const text = 'Welcome to Nammerha, a platform for rebuilding communities with transparency and hope.';
            const lower = text.toLowerCase();
    ...
    describe('Quality Estimation', () => {
        ...
        it('should preserve numbers in financial translations', () => {
            ...
            const preserved = sourceNumbers.filter((n: string) => translatedNumbers.indexOf(n) >= 0).length;
...
describe('Escrow Service (Unit)', () => {
    ...
    describe('Escrow Lifecycle', () => {
        it('should lock funds on donation', async () => {
