...
describe('Reality Capture Service', () => {
    ...
    describe('submitCapture()', () => {
        ...
        it('should accept capture without GPS (skip proximity check)', async () => {
            const mockCapture = {
                capture_id: 'cap-001',
                project_id: 'proj-001',
                engineer_id: 'eng-001',
                capture_type: 'photo_360',
                construction_phase: 'foundation',
        ...
        it('should reject capture when GPS is too far from project site', async () => {
            ...
            // Engineer claims to be in Aleppo (36.1956, 37.1320) — ~310km away
            await expect(
                submitCapture('eng-001', 'proj-001', {
    ...
    describe('getHiddenWorks()', () => {
        it('should query pre-concrete phase captures', async () => {
            ...
            expect(mockPoolQuery).toHaveBeenCalledWith(
                ...
                ['proj-001', expect.arrayContaining([
    ...
    describe('verifyCapture()', () => {
        ...
        it('should throw when capture not found', async () => {
            ...
            await expect(verifyCapture('nonexistent', 'admin-001'))
    ...
    describe('addAnnotation()', () => {
        ...
        it('should throw when capture does not exist', async () => {
            ...
            await expect(
                addAnnotation('nonexistent', 'eng-001', { note: 'Test' })
            ).rejects.toThrow('Capture not found');
        });
    });
