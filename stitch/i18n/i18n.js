...
(function () {
    ...
    var DICT = {
        ...
        // ═══ FORENSIC AUDIT i18n GAP REMEDIATION — Dynamic Template Keys (March 14 2026) ═══

        // Auth — Forgot Password Fallbacks
        'auth_forgot_sent': { ar: 'إذا كان هناك حساب بهذا البريد، فقد أُرسل رابط إعادة تعيين كلمة المرور.', de: 'Falls ein Konto mit dieser E-Mail existiert, wurde ein Link zum Zurücksetzen gesendet.', fr: 'Si un compte existe avec cet e-mail, un lien de réinitialisation a été envoyé.', tr: 'Bu e-postayla bir hesap varsa, şifre sıfırlama bağlantısı gönderildi.' },
        'auth_forgot_error': { ar: 'حدث خطأ. يرجى المحاولة مرة أخرى.', de: 'Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.', fr: 'Une erreur est survenue. Veuillez réessayer.', tr: 'Bir hata oluştu. Lütfen tekrar deneyin.' },

        // Donor Portal — Dynamic Template Strings
        'donor_no_funded_projects': { ar: 'لا توجد مشاريع ممولة بعد', de: 'Noch keine finanzierten Projekte', fr: 'Aucun projet financé pour l\'instant', tr: 'Henüz finanse edilen proje yok' },
        'donor_browse_start_impact': { ar: 'تصفح المشاريع وابدأ بإحداث تأثير', de: 'Durchsuchen Sie Projekte und beginnen Sie, etwas zu bewirken', fr: 'Parcourez les projets et commencez à avoir un impact', tr: 'Projelere göz atın ve etki yaratmaya başlayın' },
        ...
        'donor_no_donations': { ar: 'لا توجد تبرعات بعد', de: 'Noch keine Spenden', fr: 'Aucun don pour l\'instant', tr: 'Henüz bağış yok' },
        'donor_no_impact': { ar: 'لا توجد بيانات تأثير بعد', de: 'Noch keine Wirkungsdaten', fr: 'Aucune donnée d\'impact pour l\'instant', tr: 'Henüz etki verisi yok' },
        'donor_donated_label': { ar: 'تبرعت', de: 'Gespendet', fr: 'Donné', tr: 'Bağışlanan' },
        'donor_items_funded': { ar: 'بنود ممولة', de: 'Artikel finanziert', fr: 'articles financés', tr: 'kalem finanse edildi' },
        'donor_progress_label': { ar: 'التقدم', de: 'Fortschritt', fr: 'Progression', tr: 'İlerleme' },
        'donor_no_proofs': { ar: 'لا توجد إثباتات بعد', de: 'Noch keine Nachweise', fr: 'Aucune preuve pour l\'instant', tr: 'Henüz kanıt yok' },
        'donor_proofs_hint': { ar: 'الصور المعتمدة بنظام GPS تظهر هنا بعد التحقق الميداني', de: 'GPS-verifizierte Fotos erscheinen hier nach der Vor-Ort-Verifizierung', fr: 'Les photos vérifiées par GPS apparaissent ici après la vérification sur site', tr: 'GPS doğrulamalı fotoğraflar saha doğrulamasından sonra burada görünür' },
        'donor_site_proof': { ar: 'إثبات ميداني', de: 'Standortnachweis', fr: 'Preuve sur site', tr: 'Saha kanıtı' },

        // Compliance Dashboard — Dynamic Template Strings
        'compliance_all_reviewed': { ar: 'تمت مراجعة جميع إصدارات الضمان', de: 'Alle Treuhandfreigaben überprüft', fr: 'Toutes les libérations d\'entiercement examinées', tr: 'Tüm emanet serbest bırakmaları incelendi' },
        ...
        'compliance_pending': { ar: 'معلق', de: 'Ausstehend', fr: 'En attente', tr: 'Beklemede' },
        'compliance_approve': { ar: 'موافقة', de: 'Genehmigen', fr: 'Approuver', tr: 'Onayla' },
        'compliance_flag': { ar: 'تحذير', de: 'Markieren', fr: 'Signaler', tr: 'İşaretle' },

        // Donor Proof — Status Titles & Badges
        'proof_status_verified_title': { ar: 'نجاح! مساهمتك وصلت للموقع', de: 'Erfolg! Ihr Beitrag ist vor Ort', fr: 'Succès ! Votre contribution est sur site', tr: 'Başarılı! Katkınız sahada' },
        'proof_status_submitted_title': { ar: 'تم إرسال الإثبات — في انتظار التحقق', de: 'Nachweis eingereicht — Verifizierung ausstehend', fr: 'Preuve soumise — En attente de vérification', tr: 'Kanıt gönderildi — Doğrulama bekleniyor' },
        'proof_status_rejected_title': { ar: 'تم تمييز الإثبات — قيد المراجعة', de: 'Nachweis markiert — Wird überprüft', fr: 'Preuve signalée — En cours d\'examen', tr: 'Kanıt işaretlendi — İnceleniyor' },
        'proof_badge_verified': { ar: 'تم التحقق', de: 'Verifiziert', fr: 'Vérifié', tr: 'Doğrulandı' },
        'proof_badge_pending': { ar: 'معلق', de: 'Ausstehend', fr: 'En attente', tr: 'Beklemede' },
        'proof_badge_flagged': { ar: 'مُبلّغ عنه', de: 'Markiert', fr: 'Signalé', tr: 'İşaretlendi' },
        'proof_project_label': { ar: 'مشروع', de: 'Projekt', fr: 'Projet', tr: 'Proje' },
        'proof_verified_by': { ar: 'تم التحقق بواسطة', de: 'Verifiziert von', fr: 'Vérifié par', tr: 'Doğrulayan' },
        'proof_materials': { ar: 'مواد', de: 'Materialien', fr: 'matériaux', tr: 'malzemeler' },
        'proof_received_verified': { ar: 'تم استلامها والتحقق منها في الموقع', de: 'vor Ort empfangen und verifiziert', fr: 'reçue et vérifiée sur site', tr: 'sahada teslim alındı ve doğrulandı' },
        'proof_submitted_for_verification': { ar: 'تم إرسالها للتحقق', de: 'zur Verifizierung eingereicht', fr: 'soumise pour vérification', tr: 'doğrulama için gönderildi' },
        'proof_your_contribution': { ar: 'مساهمتك', de: 'Ihre', fr: 'Votre', tr: 'Sizin' },
        'proof_contribution_of': { ar: 'من', de: 'Beitrag von', fr: 'contribution de', tr: 'katkınız' },
        'proof_for_project': { ar: 'لمشروع', de: 'für Projekt', fr: 'pour le Projet', tr: 'Proje için' },
        'proof_has_been': { ar: 'قد', de: 'wurde', fr: 'a été', tr: '' },
        'proof_delivery_photo': { ar: 'صورة إثبات التسليم', de: 'Liefernachweis-Foto', fr: 'Photo de preuve de livraison', tr: 'Teslimat kanıtı fotoğrafı' },

        // Project Details — Add to Cart
        'project_added_to_cart': { ar: 'أُضيف إلى السلة', de: 'Zum Warenkorb hinzugefügt', fr: 'Ajouté au panier', tr: 'Sepete Eklendi' },

        // Supplier Dashboard — Dynamic Template Strings
        'supplier_no_orders': { ar: 'لا توجد أوامر شراء بعد', de: 'Noch keine Bestellungen', fr: 'Aucune commande pour l\'instant', tr: 'Henüz satın alma siparişi yok' },
        'supplier_catalog_empty': { ar: 'الكتالوج فارغ', de: 'Ihr Katalog ist leer', fr: 'Votre catalogue est vide', tr: 'Kataloğunuz boş' },
        'supplier_catalog_hint': { ar: 'أضف أول مادة لبدء استلام أوامر الشراء', de: 'Fügen Sie Ihr erstes Material hinzu, um Bestellungen zu erhalten', fr: 'Ajoutez votre premier matériau pour commencer à recevoir des commandes', tr: 'Sipariş almaya başlamak için ilk malzemenizi ekleyin' },
        'supplier_inactive': { ar: 'غير نشط', de: 'Inaktiv', fr: 'Inactif', tr: 'Etkin Değil' },
        'supplier_guide_price': { ar: 'السعر الاسترشادي', de: 'Richtpreis', fr: 'Prix indicatif', tr: 'Rehber Fiyat' },
        'supplier_min_order': { ar: 'الحد الأدنى للطلب', de: 'Mindestbestellung', fr: 'Commande minimum', tr: 'Minimum Sipariş' },
        'supplier_lead_time': { ar: 'مدة التسليم', de: 'Lieferzeit', fr: 'Délai de livraison', tr: 'Teslim Süresi' },
        'supplier_days': { ar: 'أيام', de: 'Tage', fr: 'jours', tr: 'gün' },
        'supplier_remove': { ar: 'إزالة', de: 'Entfernen', fr: 'Supprimer', tr: 'Kaldır' },
        'supplier_acknowledge': { ar: 'تأكيد الاستلام', de: 'Bestätigen', fr: 'Accuser réception', tr: 'Onayla' },
        'supplier_mark_shipped': { ar: 'تعليم كمشحون', de: 'Als versendet markieren', fr: 'Marquer comme expédié', tr: 'Gönderildi İşaretle' },
        'supplier_mark_delivered': { ar: 'تعليم كمسلّم', de: 'Als geliefert markieren', fr: 'Marquer comme livré', tr: 'Teslim Edildi İşaretle' },
        'supplier_update_failed': { ar: 'فشل تحديث الحالة', de: 'Statusaktualisierung fehlgeschlagen', fr: 'Échec de la mise à jour du statut', tr: 'Durum güncellemesi başarısız' },
        'supplier_status_updated': { ar: 'تم تحديث حالة الطلب بنجاح', de: 'Bestellstatus erfolgreich aktualisiert', fr: 'Statut de commande mis à jour avec succès', tr: 'Sipariş durumu başarıyla güncellendi' },
        'supplier_network_error': { ar: 'خطأ في الشبكة. يرجى المحاولة مرة أخرى.', de: 'Netzwerkfehler. Bitte versuchen Sie es erneut.', fr: 'Erreur réseau. Veuillez réessayer.', tr: 'Ağ hatası. Lütfen tekrar deneyin.' },
        'supplier_add_failed': { ar: 'فشل إضافة المادة', de: 'Material konnte nicht hinzugefügt werden', fr: 'Échec de l\'ajout du matériau', tr: 'Malzeme eklenemedi' },
        'supplier_material_added': { ar: 'تمت إضافة المادة إلى الكتالوج', de: 'Material zu Ihrem Katalog hinzugefügt', fr: 'Matériau ajouté à votre catalogue', tr: 'Malzeme kataloğunuza eklendi' },
        'supplier_remove_failed': { ar: 'فشل إزالة البند', de: 'Artikel konnte nicht entfernt werden', fr: 'Échec de la suppression de l\'article', tr: 'Öğe kaldırılamadı' },
        'supplier_material_removed': { ar: 'تمت إزالة المادة من الكتالوج', de: 'Material aus dem Katalog entfernt', fr: 'Matériau retiré du catalogue', tr: 'Malzeme katalogdan kaldırıldı' },

        // ═══ MONETIZATION — Platform Support & Revenue Dashboard (Phase 1) ═══
        'tip_label': { ar: 'ادعم المنصة', de: 'Plattform unterstützen', fr: 'Soutenir la plateforme', tr: 'Platformu Destekleyin' },
        'tip_optional': { ar: 'طوعي ١٠٠٪', de: '100 % freiwillig', fr: '100 % volontaire', tr: '%100 gönüllü' },
        'tip_amount_label': { ar: 'دعم المنصة', de: 'Plattform-Unterstützung', fr: 'Soutien plateforme', tr: 'Platform desteği' },
        'tip_total_label': { ar: 'الإجمالي مع الدعم', de: 'Gesamt mit Unterstützung', fr: 'Total avec soutien', tr: 'Destekli toplam' },
        'rev_dashboard': { ar: 'لوحة الإيرادات', de: 'Umsatz-Dashboard', fr: 'Tableau de bord revenus', tr: 'Gelir Paneli' },
        'rev_total_revenue': { ar: 'إجمالي الإيرادات', de: 'Gesamtumsatz', fr: 'Revenu total', tr: 'Toplam Gelir' },
        'rev_commissions': { ar: 'العمولات', de: 'Provisionen', fr: 'Commissions', tr: 'Komisyonlar' },
        'rev_tips': { ar: 'دعم المنصة', de: 'Plattform-Unterstützung', fr: 'Soutien plateforme', tr: 'Platform desteği' },
        'rev_avg_tip': { ar: 'متوسط الدعم', de: 'Durchschnittliche Unterstützung', fr: 'Soutien moyen', tr: 'Ortalama destek' },
        'rev_commission_rate': { ar: 'معدل العمولة', de: 'Provisionssatz', fr: 'Taux de commission', tr: 'Komisyon oranı' },
        'rev_tier_config': { ar: 'إعدادات المستويات', de: 'Stufenkonfiguration', fr: 'Configuration des paliers', tr: 'Seviye Yapılandırması' },
        'rev_recent_commissions': { ar: 'العمولات الأخيرة', de: 'Letzte Provisionen', fr: 'Commissions récentes', tr: 'Son Komisyonlar' },
        'rev_recent_tips': { ar: 'الإكراميات الأخيرة', de: 'Letzte Trinkgelder', fr: 'Pourboires récents', tr: 'Son Bahşişler' },
        'rev_no_data': { ar: 'لا توجد بيانات بعد', de: 'Noch keine Daten', fr: 'Aucune donnée', tr: 'Henüz veri yok' },
        // ─── Phase 2: Subscription / Pricing Page ───────────────────────
        'pricing_title': { ar: 'أسعار بسيطة وشفافة', de: 'Einfache, transparente Preise', fr: 'Tarification simple et transparente', tr: 'Basit, Şeffaf Fiyatlandırma' },
        'pricing_subtitle': { ar: 'اختر الخطة المناسبة لأعمال البناء الخاصة بك. يمكنك الترقية في أي وقت.', de: 'Wählen Sie den richtigen Plan für Ihr Bauunternehmen.', fr: 'Choisissez le plan adapté à votre entreprise de construction.', tr: 'İnşaat işiniz için doğru planı seçin.' },
        ...
        'pricing_free_desc': { ar: 'أدوات أساسية للبدء', de: 'Grundlegende Tools zum Starten', fr: 'Outils essentiels pour commencer', tr: 'Başlamak için temel araçlar' },
        'pricing_forever': { ar: '/للأبد', de: '/dauerhaft', fr: '/gratuit', tr: '/süresiz' },
        'pricing_premium_name': { ar: 'مميز', de: 'Premium', fr: 'Premium', tr: 'Premium' },
        'pricing_premium_desc': { ar: 'مجموعة احترافية كاملة', de: 'Vollständige professionelle Suite', fr: 'Suite professionnelle complète', tr: 'Tam profesyonel paket' },
        'pricing_per_month': { ar: '/شهرياً', de: '/Monat', fr: '/mois', tr: '/ay' },
        'pricing_recommended': { ar: 'مُوصى به', de: 'Empfohlen', fr: 'Recommandé', tr: 'Önerilen' },
        'pricing_f_boq_3': { ar: '٣ تصديرات جدول كميات شهرياً', de: '3 BOQ-Exporte pro Monat', fr: '3 exports BOQ par mois', tr: 'Ayda 3 BOQ dışa aktarma' },
        'pricing_f_boq_unlimited': { ar: 'تصدير غير محدود لجداول الكميات', de: 'Unbegrenzte BOQ-Exporte', fr: 'Exports BOQ illimités', tr: 'Sınırsız BOQ dışa aktarma' },
        'pricing_f_alerts_5': { ar: '٥ تنبيهات مشاريع شهرياً', de: '5 Projektbenachrichtigungen/Monat', fr: '5 alertes projet par mois', tr: 'Ayda 5 proje bildirimi' },
        'pricing_f_alerts_unlimited': { ar: 'تنبيهات مشاريع غير محدودة', de: 'Unbegrenzte Projektbenachrichtigungen', fr: 'Alertes projet illimitées', tr: 'Sınırsız proje bildirimi' },
        'pricing_f_oracle_basic': { ar: 'الوصول الأساسي لمؤشر الأسعار', de: 'Basis-Zugang zum Preisindex', fr: 'Accès de base à l\'indicateur de prix', tr: 'Temel fiyat endeksi erişimi' },
        'pricing_f_oracle_adv': { ar: 'تحليلات متقدمة وتوقعات', de: 'Erweiterte Analytik & Prognosen', fr: 'Analyses avancées et prévisions', tr: 'Gelişmiş analitik ve tahminler' },
        'pricing_f_profile': { ar: 'ملف تعريف احترافي', de: 'Professionelles Profil', fr: 'Profil professionnel', tr: 'Profesyonel profil' },
        'pricing_f_whitelabel': { ar: 'تقارير بعلامتك التجارية', de: 'Berichte mit eigenem Branding', fr: 'Rapports personnalisés', tr: 'Markalı raporlar' },
        'pricing_f_priority': { ar: 'أولوية في نتائج البحث', de: 'Priorität in Suchergebnissen', fr: 'Priorité dans les résultats de recherche', tr: 'Arama sonuçlarında öncelik' },
        'pricing_current_plan': { ar: 'خطتك الحالية', de: 'Aktueller Plan', fr: 'Plan actuel', tr: 'Mevcut Plan' },
        'pricing_upgrade': { ar: 'الترقية للمميز', de: 'Auf Premium upgraden', fr: 'Passer au Premium', tr: 'Premium\'e Yükselt' },
        'pricing_cancel_anytime': { ar: 'إلغاء في أي وقت. بدون أسئلة. بياناتك آمنة.', de: 'Jederzeit kündbar. Keine Fragen. Ihre Daten sind sicher.', fr: 'Annulation à tout moment. Sans questions. Vos données restent sécurisées.', tr: 'İstediğiniz zaman iptal edin. Soru sorulmaz. Verileriniz güvende.' },
        'pricing_secure': { ar: 'مدفوعات آمنة', de: 'Sichere Zahlungen', fr: 'Paiements sécurisés', tr: 'Güvenli ödemeler' },
        'pricing_ocds': { ar: 'متوافق مع OCDS', de: 'OCDS-konform', fr: 'Conforme OCDS', tr: 'OCDS Uyumlu' },
        'pricing_global': { ar: 'تغطية عالمية', de: 'Globale Abdeckung', fr: 'Couverture mondiale', tr: 'Küresel Kapsam' },
        // ─── 4-Tier Pricing: Pro / Business / Enterprise ─────────────────
        'pricing_pro_name': { ar: 'احترافي', de: 'Pro', fr: 'Pro', tr: 'Pro' },
        'pricing_pro_desc': { ar: 'للمقاولين المحليين', de: 'Für lokale Auftragnehmer', fr: 'Pour les entrepreneurs locaux', tr: 'Yerel müteahhitler için' },
        'pricing_business_name': { ar: 'أعمال', de: 'Business', fr: 'Business', tr: 'İş' },
        'pricing_business_desc': { ar: 'للشركات النامية', de: 'Für wachsende Unternehmen', fr: 'Pour les entreprises en croissance', tr: 'Büyüyen firmalar için' },
        'pricing_enterprise_name': { ar: 'مؤسسات', de: 'Enterprise', fr: 'Entreprise', tr: 'Kurumsal' },
        'pricing_enterprise_desc': { ar: 'للمنظمات الدولية', de: 'Für internationale Organisationen', fr: 'Pour les organisations internationales', tr: 'Uluslararası kuruluşlar için' },
        'pricing_get_pro': { ar: 'اشترك بالاحترافي', de: 'Pro holen', fr: 'Obtenir Pro', tr: 'Pro\'ya geç' },
        'pricing_get_business': { ar: 'اشترك بالأعمال', de: 'Business holen', fr: 'Obtenir Business', tr: 'İş\'e geç' },
        'pricing_contact_sales': { ar: 'تواصل مع المبيعات', de: 'Vertrieb kontaktieren', fr: 'Contacter les ventes', tr: 'Satış ile iletişime geçin' },
        'pricing_per_month_yearly': { ar: '/شهرياً (يُفوتر سنوياً)', de: '/Monat (jährliche Abrechnung)', fr: '/mois (facturé annuellement)', tr: '/ay (yıllık faturalandırma)' },
        'pricing_subscribed': { ar: 'تم الاشتراك!', de: 'Abonniert!', fr: 'Abonné !', tr: 'Abone olundu!' },
        'pricing_error': { ar: 'خطأ', de: 'Fehler', fr: 'Erreur', tr: 'Hata' },
        'pricing_try_again': { ar: 'حاول مجدداً', de: 'Erneut versuchen', fr: 'Réessayer', tr: 'Tekrar dene' },
        'pricing_f_boq_15': { ar: '١٥ تصدير جدول كميات شهرياً', de: '15 BOQ-Exporte/Monat', fr: '15 exports BOQ/mois', tr: 'Ayda 15 BOQ dışa aktarma' },
        'pricing_f_alerts_25': { ar: '٢٥ تنبيه مشروع شهرياً', de: '25 Projektbenachrichtigungen/Monat', fr: '25 alertes projet/mois', tr: 'Ayda 25 proje bildirimi' },
        'pricing_f_invoices': { ar: 'إدارة الفواتير', de: 'Rechnungsverwaltung', fr: 'Gestion des factures', tr: 'Fatura yönetimi' },
        'pricing_f_bids_unlimited': { ar: 'مزايدات غير محدودة', de: 'Unbegrenzte Gebote', fr: 'Enchères illimitées', tr: 'Sınırsız teklif verme' },
        'pricing_f_everything_business': { ar: 'كل ميزات خطة الأعمال', de: 'Alles in Business', fr: 'Tout de Business', tr: 'Business\'taki her şey' },
        'pricing_f_priority_support': { ar: 'دعم ذو أولوية', de: 'Prioritäts-Support', fr: 'Support prioritaire', tr: 'Öncelikli destek' },
        'pricing_f_custom_reports': { ar: 'تقارير مخصصة', de: 'Individuelle Berichte', fr: 'Rapports personnalisés', tr: 'Özel raporlar' },
        'pricing_f_api_access': { ar: 'وصول API', de: 'API-Zugang', fr: 'Accès API', tr: 'API erişimi' },
        'pricing_f_dedicated_manager': { ar: 'مدير حساب مخصص', de: 'Dedizierter Account-Manager', fr: 'Gestionnaire de compte dédié', tr: 'Özel hesap yöneticisi' },
        'pricing_f_sla': { ar: 'ضمان مستوى الخدمة', de: 'SLA-Garantie', fr: 'Garantie SLA', tr: 'SLA garantisi' },
        'pricing_f_onboarding': { ar: 'مساعدة في الإعداد', de: 'Onboarding-Unterstützung', fr: 'Assistance à l\'intégration', tr: 'Kurulum desteği' },
        // ─── Phase 3: FinTech & Enterprise TaaS ─────────────────────────
        'fintech_title': { ar: 'التكنولوجيا المالية والمؤسسات', de: 'FinTech & Enterprise', fr: 'FinTech & Entreprise', tr: 'FinTech & Kurumsal' },
        'fintech_subtitle': { ar: 'رسوم الضمان واشتراكات المؤسسات وإدارة TaaS', de: 'Treuhandgebühren, Unternehmensabonnements und TaaS-Verwaltung', fr: 'Frais de séquestre, abonnements entreprise et gestion TaaS', tr: 'Emanet ücretleri, kurumsal abonelikler ve TaaS yönetimi' },
        'fintech_back': { ar: 'العودة للوحة التحكم', de: 'Zurück zum Dashboard', fr: 'Retour au tableau de bord', tr: 'Panele geri dön' },
        'fintech_escrow_fees': { ar: 'رسوم الضمان', de: 'Treuhandgebühren', fr: 'Frais de séquestre', tr: 'Emanet ücretleri' },
        'fintech_enterprise_orgs': { ar: 'المؤسسات', de: 'Organisationen', fr: 'Organisations', tr: 'Kuruluşlar' },
        'fintech_mtd_fees': { ar: 'رسوم الشهر', de: 'Gebühren dieses Monats', fr: 'Frais du mois', tr: 'Bu ay ücretleri' },
        'fintech_api_calls': { ar: 'استدعاءات API', de: 'API-Aufrufe', fr: 'Appels API', tr: 'API çağrıları' },
        'fintech_all_time': { ar: 'الإجمالي', de: 'Gesamt', fr: 'Total', tr: 'Toplam' },
        'fintech_active': { ar: 'نشطة', de: 'Aktiv', fr: 'Actives', tr: 'Aktif' },
        'fintech_this_month': { ar: 'هذا الشهر', de: 'Diesen Monat', fr: 'Ce mois', tr: 'Bu ay' },
        'fintech_fee_config': { ar: 'إعدادات الرسوم', de: 'Gebührenkonfiguration', fr: 'Configuration des frais', tr: 'Ücret yapılandırması' },
        'fintech_enterprise_list': { ar: 'المؤسسات المشتركة', de: 'Unternehmensorganisationen', fr: 'Organisations entreprise', tr: 'Kurumsal kuruluşlar' },
        'fintech_add_org': { ar: 'إضافة مؤسسة', de: 'Organisation hinzufügen', fr: 'Ajouter une organisation', tr: 'Kuruluş ekle' },
        'fintech_loading': { ar: 'جاري التحميل...', de: 'Laden...', fr: 'Chargement...', tr: 'Yükleniyor...' },
        'fintech_fee_name': { ar: 'الاسم', de: 'Name', fr: 'Nom', tr: 'İsim' },
        'fintech_inactive': { ar: 'غير نشطة', de: 'Inaktiv', fr: 'Inactive', tr: 'Pasif' },
        'fintech_no_configs': { ar: 'لا توجد إعدادات رسوم', de: 'Keine Gebührenkonfigurationen', fr: 'Aucune configuration de frais', tr: 'Ücret yapılandırması yok' },
        'fintech_no_orgs': { ar: 'لا مؤسسات حتى الآن', de: 'Noch keine Organisationen', fr: 'Aucune organisation pour le moment', tr: 'Henüz kuruluş yok' },
    };
