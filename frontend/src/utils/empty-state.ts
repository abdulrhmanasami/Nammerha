...
//       icon: 'hand-heart',
//       title: t('no_items', 'لا توجد عناصر بعد'),
//       subtitle: t('no_items_hint', 'تصفّح المشاريع للبدء'),
//       ctaLabel: t('browse_projects', 'تصفّح المشاريع'),
...
export function renderEmptyState(config: EmptyStateConfig): string {
  const { icon, title, subtitle, ctaLabel, ctaHref, ctaI18nKey, fullSpan = false } = config;
