...
export const ROUTE_MAP: Record<string, BreadcrumbItem[]> = {
  ...
  'engineer-camera.html': [
    { label: 'Projects', href: 'index.html', i18n: 'projects', icon: 'squares-four' },
    {
      ...
      i18n: 'engineer_boq_builder',
      icon: 'clipboard-text',
    },
    { label: 'Site Verification', i18n: 'site_verification', icon: 'camera' },
  ],
  // P2-003: user-proof.html ERADICATED — payment Eradication KI (May 2026)
  ...
  // P2-003: user-basket.html ERADICATED — payment Eradication KI (May 2026)
...
export function initBreadcrumb(): void {
  ...
  const container =
    document.getElementById('main-content') ?? document.querySelector('.mobile-container');
