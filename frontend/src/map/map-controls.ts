...
export function createFilterControl(
    ...
    const filters: { label: string; value: ProjectFilter; i18nKey: string }[] = [
        { label: t('filter_all', 'All'), value: 'all', i18nKey: 'filter_all' },
        { label: t('filter_needs_funding', 'Needs Funding'), value: 'needs_funding', i18nKey: 'filter_needs_funding' },
        { label: t('filter_in_progress', 'In Progress'), value: 'in_progress', i18nKey: 'filter_in_progress' },
        { label: t('filter_completed', 'Completed'), value: 'completed', i18nKey: 'filter_completed' },
    ];
