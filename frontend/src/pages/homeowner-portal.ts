        ...
        container.innerHTML = `
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-blue-50 rounded-xl p-4">
                    ...
                    <p class="text-xl font-black mt-1 text-blue-700">$${((e.total_deposited ?? 0) / 100).toLocaleString()}</p>
                </div>
                <div class="bg-green-50 rounded-xl p-4">
                    <p class="text-[10px] font-bold text-green-400 uppercase">Released</p>
                    <p class="text-xl font-black mt-1 text-green-700">$${((e.total_released ?? 0) / 100).toLocaleString()}</p>
                </div>
                <div class="bg-amber-50 rounded-xl p-4">
                    <p class="text-[10px] font-bold text-amber-400 uppercase">Held in Escrow</p>
                    <p class="text-xl font-black mt-1 text-amber-700">$${((e.held_in_escrow ?? 0) / 100).toLocaleString()}</p>
                </div>
