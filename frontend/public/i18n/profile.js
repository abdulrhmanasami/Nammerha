...
(function () {
    ...
    if (typeof window.__nmDictMerge === 'function') {
        ...
        // ═══ PW1: Profile HTML labels ═══
        'edit_profile': { ar: 'تعديل الملف الشخصي', de: 'Profil bearbeiten', fr: 'Modifier le profil', tr: 'Profili Düzenle' },
        'full_name': { ar: 'الاسم الكامل', de: 'Vollständiger Name', fr: 'Nom complet', tr: 'Ad Soyad' },
        ...
        'photo_hint': { ar: 'PNG أو JPG، حد أقصى ٢ ميغابايت', de: 'PNG oder JPG, max. 2 MB', fr: 'PNG ou JPG, max 2 Mo', tr: 'PNG veya JPG, maks 2 MB' },
        'photo_selected': { ar: 'تم اختيار صورة', de: 'Foto ausgewählt', fr: 'Photo sélectionnée', tr: 'Fotoğraf seçildi' },
        ...
        'change_password': { ar: 'تغيير كلمة المرور', de: 'Passwort ändern', fr: 'Changer le mot de passe', tr: 'Şifreyi Değiştir' },
        ...
        'password_strength_hint': { ar: '+٨ أحرف، حرف كبير، رقم', de: '8+ Zeichen, Großbuchstabe, Zahl', fr: '8+ car., majuscule, chiffre', tr: '8+ karakter, büyük harf, rakam' },
        ...
        'add_new_role': { ar: 'إضافة دور جديد', de: 'Neue Rolle hinzufügen', fr: 'Ajouter un nouveau rôle', tr: 'Yeni Rol Ekle' },
        'choose_role_to_activate': { ar: 'اختر دوراً لتفعيله', de: 'Rolle zum Aktivieren auswählen', fr: 'Choisir un rôle à activer', tr: 'Etkinleştirilecek rolü seçin' },
        'settings': { ar: 'الإعدادات', de: 'Einstellungen', fr: 'Paramètres', tr: 'Ayarlar' },
        'my_wallet': { ar: 'محفظتي', de: 'Meine Geldbörse', fr: 'Mon portefeuille', tr: 'Cüzdanım' },
        'wallet_desc': { ar: 'عرض الرصيد والمعاملات', de: 'Guthaben und Transaktionen anzeigen', fr: 'Voir le solde et les transactions', tr: 'Bakiye ve işlemleri görüntüle' },
        'admin_portal': { ar: 'بوابة المشرف', de: 'Admin-Portal', fr: 'Portail Admin', tr: 'Yönetici Portalı' },
        'admin_portal_desc': { ar: 'إدارة المنصة', de: 'Plattformverwaltung', fr: 'Gestion de la plateforme', tr: 'Platform Yönetimi' },
        'confirm_logout_title': { ar: 'تسجيل الخروج', de: 'Abmelden', fr: 'Déconnexion', tr: 'Çıkış Yap' },
        'confirm_logout_desc': { ar: 'هل تريد تسجيل الخروج من حسابك؟', de: 'Möchten Sie sich abmelden?', fr: 'Voulez-vous vous déconnecter ?', tr: 'Hesabınızdan çıkış yapmak istiyor musunuz?' },

        // ═══ PW2: Profile TS runtime keys ═══
        'saving': { ar: 'جاري الحفظ...', de: 'Wird gespeichert...', fr: 'Enregistrement...', tr: 'Kaydediliyor...' },
        'updating': { ar: 'جاري التحديث...', de: 'Wird aktualisiert...', fr: 'Mise à jour...', tr: 'Güncelleniyor...' },
        'profile_saved': { ar: 'تم حفظ الملف الشخصي', de: 'Profil gespeichert', fr: 'Profil enregistré', tr: 'Profil kaydedildi' },
        'profile_save_failed': { ar: 'فشل حفظ الملف الشخصي', de: 'Profil konnte nicht gespeichert werden', fr: 'Échec de l\'enregistrement du profil', tr: 'Profil kaydedilemedi' },
        ...
        'profile_no_roles': { ar: 'لا توجد أدوار مُفعّلة', de: 'Keine aktiven Rollen', fr: 'Aucun rôle actif', tr: 'Aktif rol yok' },
        'profile_all_roles_active': { ar: 'جميع الأدوار مُفعّلة', de: 'Alle Rollen aktiv', fr: 'Tous les rôles actifs', tr: 'Tüm roller aktif' },
        'profile_sign_in_prompt': { ar: 'سجّل دخولك لعرض ملفك', de: 'Melden Sie sich an, um Ihr Profil zu sehen', fr: 'Connectez-vous pour voir votre profil', tr: 'Profilinizi görmek için giriş yapın' },
        'profile_sign_in_roles': { ar: 'سجّل دخولك لعرض الأدوار', de: 'Anmelden, um Rollen zu sehen', fr: 'Connectez-vous pour voir les rôles', tr: 'Rolleri görmek için giriş yapın' },
        ...
        'kyc_flow_coming_soon': { ar: 'التحقق من الهوية — قريباً', de: 'KYC-Verifizierung — demnächst', fr: 'Vérification KYC — bientôt', tr: 'KYC Doğrulaması — yakında' },
        'password_changed_success': { ar: 'تم تغيير كلمة المرور', de: 'Passwort geändert', fr: 'Mot de passe modifié', tr: 'Şifre değiştirildi' },
        'password_change_failed': { ar: 'فشل تغيير كلمة المرور', de: 'Passwortänderung fehlgeschlagen', fr: 'Échec du changement de mot de passe', tr: 'Şifre değiştirme başarısız' },
        'password_empty': { ar: 'كلمة المرور فارغة', de: 'Passwort leer', fr: 'Mot de passe vide', tr: 'Şifre boş' },
