...
(function () {
    ...
    if (typeof window.__nmDictMerge === 'function') {
        ...
        'what_kind_of_damage': { ar: 'نحن هنا لمساعدتك. ما الذي تضرر في منزلك؟', de: 'Welche Art von Schaden?', fr: 'Quel type de dégât ?', tr: 'Hasar türü nedir?' },
        'where_is_your': { ar: 'أين يقع المنزل المتضرر؟', de: 'Wo befindet sich Ihr Haus?', fr: 'Où se trouve votre maison ?', tr: 'Eviniz nerede?' },
        'describe_the_damage': { ar: 'كيف يمكننا مساعدتك؟ صف لنا ما حدث', de: 'Beschreiben Sie den Schaden', fr: 'Décrivez les dégâts', tr: 'Hasarı tanımlayın' },
        'describe_the_damage_clearly_we_ll_conve': { ar: 'خذ وقتك.. يمكنك التحدث بصوتك لتوثيق الأضرار', de: 'Beschreiben Sie den Schaden deutlich — wir konvertieren Ihre Sprache in Text', fr: 'Décrivez les dégâts clairement — nous convertirons votre voix en texte', tr: 'Hasarı net tanımlayın — sesinizi metne çevireceğiz' },
        ...
        'select_the_type_that_best_describes_your': { ar: 'يرجى اختيار النوع الأقرب لوصف الضرر، لا تقلق إذا لم تكن متأكداً', de: 'Wählen Sie den Typ, der Ihren Schaden am besten beschreibt', fr: 'Sélectionnez le type décrivant le mieux vos dégâts', tr: 'Hasarınızı en iyi tanımlayan türü seçin' },
        ...
        'we_need_this_to_connect_you_with_nearby': { ar: 'نحتاج لموقعك لنتمكن من توجيه فرق الدعم الهندسية إليك في أسرع وقت', de: 'Wir brauchen dies, um Sie mit Experten in der Nähe zu verbinden', fr: 'Nécessaire pour vous connecter aux experts à proximité', tr: 'Sizi yakındaki uzmanlara bağlamak için bu gerekli' },
        ...
        'type_or_use_voice_to_tell_us_what_happen': { ar: 'خذ وقتك.. يمكنك الكتابة أو التحدث بصوتك لتوثيق الأضرار', de: 'Tippen oder Sprache verwenden, um uns zu erzählen, was passiert ist', fr: 'Tapez ou utilisez la voix pour nous dire ce qui s\'est passé', tr: 'Neler olduğunu bize yazarak veya ses ile anlatın' },
